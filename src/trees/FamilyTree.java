...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("colon does not exist");
		...
		else
		{
			...
			if (parentNode == null)
				throw new TreeException("Error in DataFile");
		...
		{
			TreeNode kid = new TreeNode(childrenArray[i]);
			parentNode.addChild(kid);
		}
	}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("child does not exist");
